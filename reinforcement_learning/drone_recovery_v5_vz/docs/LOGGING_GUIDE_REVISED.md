...
│
├── logs/
│   ├── gated_curriculum/                     ← TensorBoard logs (optional, see below)
│   │   └── PPO_1/
│   │       └── events.out.tfevents...
│   │
│   └── stage3/                               ← ALL YOUR LOGS HERE ✅
...
## 📊 **UNDERSTANDING THE TWO LOG SYSTEMS:**

### **System 1: TensorBoard Logs (`logs/gated_curriculum/`)**

**What is it?**
- Automatically created by Stable-Baselines3
- Contains low-level PPO training metrics
- Created by this line in code: `tensorboard_log="./logs/gated_curriculum/"`
...
- Gradient norms
- Episode rewards (internal PPO tracking)
...
- ✅ Checking for gradient explosions
- ✅ Deep ML diagnostics

**For PhD thesis?**
- ❌ **DO NOT USE** - These are internal ML metrics
- ❌ Not relevant for thesis figures/tables
...
**What is it?**
- Created by our custom callback
- Contains high-level performance metrics
- Designed specifically for PhD analysis
...
# Excel, pandas, or any CSV reader
```

**When to use?**
- ✅ **PhD THESIS** - All figures and tables
...
|---------|-------------|-------------------|
| **Purpose** | ML debugging | PhD analysis |
| **Audience** | ML engineers | Thesis examiners |
| **Metrics** | Policy loss, value loss, entropy | Recovery rate, curriculum level |
| **Format** | Binary event files | CSV + JSON |
| **Viewing** | TensorBoard web UI | Python plots, Excel |
| **Thesis use** | ❌ No | ✅ Yes |
| **Created by** | Stable-Baselines3 | Our callback |
| **Location** | `logs/gated_curriculum/` | `logs/stage3/` |
...
**Keep both systems:**
- `logs/gated_curriculum/` - For debugging if needed (ignore for thesis)
- `logs/stage3/` - **For all thesis work** (figures, tables, analysis)

**You can safely ignore `logs/gated_curriculum/` for your PhD work!**
