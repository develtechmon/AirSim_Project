...
Usage:
    python test_hover_policy_v2.py --model ./models_v2/hover_policy_best.pth --episodes 10
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='./models_v2/hover_policy_best.pth',
