...
def test_policy(model_path, vecnormalize_path, num_episodes=10, wind_strength=5.0):
    ...
    print("\n" + "="*70)
    print("🧪 TESTING STAGE 2: DISTURBANCE RECOVERY")
    print("="*70)
    ...
    print("="*70)
    print(f"Stage 1 (no wind):  100% success, 0.39m avg distance")
...
def find_model_files(model_path, vecnormalize_path):
    ...
    print("   python test_stage2_policy.py --model <path> --vecnormalize <path>")
    exit(1)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Test Stage 2 disturbance recovery policy',
