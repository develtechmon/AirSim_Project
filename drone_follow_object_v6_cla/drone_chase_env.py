...
class DroneChaseEnv(gym.Env):
    ...
    def __init__(self, 
        ...
        self.max_altitude_diff = 15.0  # NEW: Max altitude difference from target
    ...
    def _calculate_reward(self, current_distance, previous_distance, 
        ...
        # ═══════════════════════════════════════════════════════════
        # 4. ACTION MAGNITUDE - Reward for trying
        # ═══════════════════════════════════════════════════════════
        if action_magnitude > 2.0:  # Strong action
